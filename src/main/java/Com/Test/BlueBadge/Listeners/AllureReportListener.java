...
public class AllureReportListener  extends BasePage implements ITestListener  {
	...
	public void onTestStart(ITestResult iTestResult ) {
		System.out.println("I am in onTestStart "+ getTestMethodName(iTestResult)+" started");
		}
	...
	public void onTestFailedButWithinSuccessPercentage(ITestResult iTestResult) {
		System.out.println("I am in onTestFailedButWithinSuccessPercetage method "+ getTestMethodName(iTestResult));
